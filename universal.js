...
let createRandomCard = function() {
    ...
    if (type != 'playable' || rarity == 'evil') {
        ...
        if (rarity == 'common') {
        let atk = Math.floor(Math.random() * (3 - 1 + 1) ) + 1;
        let def = Math.floor(Math.random() * (3 - 1 + 1) ) + 1;
        let defcha = Math.floor(Math.random() * (3 - 0 + 1) ) + 0;
        let critcha = Math.floor(Math.random() * (3 - 0 + 1) ) + 0;
        } else if (rarity == 'uncommon') {
            let atk = Math.floor(Math.random() * (6 - 4 + 1) ) + 4;
            let def = Math.floor(Math.random() * (6 - 4 + 1) ) + 4;
            let defcha = Math.floor(Math.random() * (6 - 4 + 1) ) + 4;
            let critcha = Math.floor(Math.random() * (6 - 4 + 1) ) + 4;
        } else if (rarity == 'rare') {
            let atk = Math.floor(Math.random() * (9 - 7 + 1) ) + 7;
            let def = Math.floor(Math.random() * (9 - 7 + 1) ) + 7;
            let defcha = Math.floor(Math.random() * (8 - 7 + 1) ) + 7;
            let critcha = Math.floor(Math.random() * (8 - 7 + 1) ) + 7;
        } else if (rarity == 'epic') {
            let atk = Math.floor(Math.random() * (12 - 10 + 1) ) + 10;
            let def = Math.floor(Math.random() * (12 - 10 + 1) ) + 10;
            let defcha = Math.floor(Math.random() * (10 - 9 + 1) ) + 9;
            let critcha = Math.floor(Math.random() * (10 - 9 + 1) ) + 9;
        } else if (rarity == 'legendary') {
            let atk = Math.floor(Math.random() * (16 - 13 + 1) ) + 13;
            let def = Math.floor(Math.random() * (16 - 13 + 1) ) + 13;
            let defcha = Math.floor(Math.random() * (12 - 11 + 1) ) + 11;
            let critcha = Math.floor(Math.random() * (12 - 11 + 1) ) + 11;
        }
    ...
    document.getElementById('container').append(this.element)
}