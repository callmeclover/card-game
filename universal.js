...
function createRandomCard() {
  ...
  if (type !== 'playable' || rarity === 'evil') {
    ...
    if (rarity === 'evil') {
      element = "<card class='evil' onclick='if (!this.classList.contains(\"flippedevil\")) { this.classList.add('flippedevil') }'><div class='cardfront'></div><div class='cardback'><span id='name'>" + name + "</span><br><span id='type' style='color: fuchsia; font-size: small;'>" + type + "</span><br><span>" + desc + "</span></div></card>";
    } else {
